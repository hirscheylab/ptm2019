...
#Commented out parsing and saving code, but then set this code chunk to eval/include = FALSE, so re-running the entire code fresh will simply skip this chunk, and load the raw data files as a df
...
```{r}
write_delim(ptm, "ptm.csv", delim = ",", na = "")
write_delim(metabolites, "metabolites.csv", delim = ",", na = "")
```
